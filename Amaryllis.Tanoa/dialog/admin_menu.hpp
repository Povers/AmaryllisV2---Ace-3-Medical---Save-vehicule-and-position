class life_admin_menu {
	...
	class controls {
		...
		class Spectate : Life_RscButtonMenu {
			idc = 2905;
			text = "Caméra";
			onButtonClick = "[] call life_fnc_adminCam;";
		...
		class Teleport : Life_RscButtonMenu {
			...
			onButtonClick = "[] call life_fnc_adminTeleport; hint 'Veuillez selectionner votre lieu de destination.';";
        ...
        class GodCar : Life_RscButtonMenu {
			idc = 2914;
			text = "God Car";
			onButtonClick = "[] spawn life_fnc_GodModeCar;";		
			x = 0.1 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.89 + (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);			
        ...
        class Invi : Life_RscButtonMenu {
			idc = 2915;
			text = "Invisibilité";
			onButtonClick = "[] spawn life_fnc_adminInvi;";		
			x = 0.42 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.89 + (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);			
...
/*
		class Zeus : Life_RscButtonMenu {
			idc = 2914;
			text = "Zeus";
			onButtonClick = "[] spawn life_fnc_zeus;";		
			x = -0.06 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.88 + (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
