...
if (grpPlayer getVariable "gang_owner" != steamid) exitWith {hint "Tu n'est pas le leader du groupe"};					//Seul le leader peut retirer l'argent du gang -Added by Aaron
