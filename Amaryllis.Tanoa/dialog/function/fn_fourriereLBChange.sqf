...
_retrievePrice = [_className,__GETC__(life_four_prices)] call TON_fnc_index;
...
_retrievePrice = if(_retrievePrice == -1) then {10000} else {(__GETC__(life_four_prices) select _retrievePrice) select 1;};
...
(getControl(2850,2853)) ctrlSetStructuredText parseText format["
État: %12<br/>
Frais de fourrière: %1€<br/>
Couleur/type: %8<br/>
",
