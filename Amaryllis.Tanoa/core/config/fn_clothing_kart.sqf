...
switch (_filter) do
{
	...
	case 0:
	{
		...
		["U_C_Driver_2",nil,200],
		["U_C_Driver_1",nil,200],
		["U_C_Driver_3",nil,200],
		["U_C_Driver_4",nil,200]
		];
	};
	...
	{
		[
			["H_RacingHelmet_1_black_F",nil,300],
			["H_RacingHelmet_1_red_F",nil,300],
			["H_RacingHelmet_1_white_F",nil,300],
			["H_RacingHelmet_1_blue_F",nil,300],
			["H_RacingHelmet_1_yellow_F",nil,300],
			["H_RacingHelmet_1_green_F",nil,300],
