...
switch(_mode) do {
	...
	case 4: {
		...
		_query = format["UPDATE players SET alive='%1' WHERE playerid='%2'",_value,_uid]; // A VOIR
	};
	...
	case 8: {
		...
		_query = format["UPDATE players SET civPosition='%1',alive='%2' WHERE playerid='%3'",_value1,_value2,_uid]; // A VOIR
	};
};
