...
["CALL increaseReboot",1] spawn DB_fnc_asyncCall; // Augmente reboot veh
["CALL increaseRebootMsg",1] spawn DB_fnc_asyncCall; // Augmente reboot msg
...
["CALL resetLifeVehicles",1] spawn DB_fnc_asyncCall; // Reset vehicule reboot
["CALL goFour",1] spawn DB_fnc_asyncCall; // Reset vehicule reboot

sleep 15;

["CALL deleteMsg",1] spawn DB_fnc_asyncCall; // Augmente reboot msg
["CALL resetReboot",1] spawn DB_fnc_asyncCall; // Reset vehicule reboot

// Load des véhicules
[] call TON_fnc_vehicleLoad;

// Boucle save position vehicles
[] spawn TON_fnc_vehicleSave;
